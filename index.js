...
class BeachMonitor {
    constructor() {
        this.scraper = new BeachDataScraper();
    ...
    async initialize() {
        try {
            console.log('Initializing Beach Monitor...');
    ...
    async runScrapeAndPublish() {
        try {
            ...
            beachData.forEach(beach => {
                ...
                console.log(`  Wave Height: ${beach.waveHeight || 'N/A'}`);
                console.log(`  Water Temp: ${beach.waterTemperature || 'N/A'}`);
                console.log(`  Wind: ${beach.wind || 'N/A'}`);
            });
            console.log('---------------\n');
